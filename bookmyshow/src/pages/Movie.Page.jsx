    ...
    <>
      ...
      <div className="my-12 container px-4 ml:ml-20 lg:w-2/1">
        <div className="flex flex-col items-start gap-3">
          <h1 className="text-gray-800 font-bold tex-2xl">About the movie</h1>
          <p>{movie.overview}</p>
        </div>
        ...
        <div className="my-8">
          <h2 className="text-gray-800 font-bold tex-2xl mb-3">
            Applicable Offers
          </h2>
          <div className="flex flex-col gap-3 lg:flex-row">
            ...
            <div className="flex items-start gap-2 bg-yellow-100 p-3 border-yellow-400 border-dashed border-2 rounded-md">
              ...
              <div className="flex flex-col items-start">
                <h3 className="text-gray-700 tex-xl font-bold">
                  Visa Stream Offer
                </h3>
